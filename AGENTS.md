...
- `backend/` — FastAPI service (Python 3.14, uv). See `backend/AGENTS.md`.
- `frontend/` — React + TanStack Start app. See `frontend/AGENTS.md` (also contains the TanStack skill-mapping table).
...
Never add `Co-Authored-By: Codex` or any Codex/Anthropic attribution to commit messages.
